...
export default function ManagerScreen() {
  ...
  const ACTIONS: { label: string; desc: string; path: string; svg: React.ReactNode }[] = [
    ...
    { label: 'Suppliers', desc: 'Who the resort buys from', path: '/manager/suppliers', svg: (
      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" aria-hidden="true">
        <path d="M2 8h11v7H2V8zM13 10h3l2 2v3h-5v-5z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round"/>
        <circle cx="6" cy="16" r="1.4" stroke="currentColor" strokeWidth="1.5"/>
    ...
    { label: 'Reconcile', desc: 'M-Pesa & bank vs statement', path: '/manager/reconcile', svg: (
      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" aria-hidden="true">
        <path d="M3 7h11M3 7l3-3M3 7l3 3" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M17 13H6M17 13l-3-3M17 13l-3 3" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>
    ) },
